...
const testimonials = [
  {
    quote:
      'Waking up to the sound of jungle birds, coffee in hand by the pool — HeavenVilla changed how I understand rest.',
    name: 'Anastasia M.',
  ...
  {
    quote:
      "The most intentional place I've ever stayed. Nothing was overlooked. Even the silence felt curated.",
    name: 'David Chen',
    origin: 'Singapore',
  ...
  {
    quote:
      'Our honeymoon was everything we could have dreamed of. The team made every moment feel like magic.',
    name: 'Priya & Karan S.',
    origin: 'Mumbai, India',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((t) => (
            <blockquote
              key={t.name}
              className="bg-ivory p-7 border border-ivory-dark hover:border-gold/30 transition-colors duration-500"
            >
