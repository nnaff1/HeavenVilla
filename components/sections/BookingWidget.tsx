        ...
        <div className="bg-forest-dark shadow-2xl shadow-forest-dark/40">
          <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-white/10">
            ...
            <div className="p-5">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="w-6 h-6 border border-white/20 text-ivory/60 hover:border-gold hover:text-gold flex items-center justify-center transition-all"
                >
                  −
                </button>
            ...
            <div className="p-3 flex items-center">
              <Link
                href="/rooms"
                className="w-full h-full bg-gold text-forest-dark font-medium text-sm tracking-widest uppercase flex items-center justify-center gap-2 hover:bg-gold-light transition-colors duration-300 py-2"
              >
                Explore Villas
              </Link>
            </div>
